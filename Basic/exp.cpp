...
bool wrongName(string S){
    if (S == "REM" || S == "LET" ||S == "PRINT" || S == "INPUT"|| S == "END"|| S == "GOTO"|| S == "IF"|| S == "THEN"|| S == "RUN"|| S == "LIST"|| S == "CLEAR"|| S == "QUIT"|| S == "HELP" ){
        return true;
    }
    return false;
}
...
int CompoundExp::eval(EvalState &state) {
    if (op == "=") {
        ...
        else if(wrongName(((IdentifierExp *) lhs)->getName())){
            throw "SYNTAX ERROR";
        }
