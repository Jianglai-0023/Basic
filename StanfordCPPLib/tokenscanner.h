 ...
 * identically相同的 and therefore does not provide any special processing for
 * numbers.  Calling
 *
 *<pre>
 *    scanner.scanNumbers();
 ...
 * longest substring子链 that can be interpreted解释 as a real number.
 */
 ...
 * By default, quotation marks (either single or double) are treated just like
